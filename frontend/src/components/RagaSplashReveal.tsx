...
export const RagaSplashReveal: React.FC<RagaSplashRevealProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        ref={pillRef}
        className="relative h-[130px] rounded-full border-[6px] border-[#220738] bg-gradient-to-b from-[#FFE817] via-[#FFCA00] to-[#FFA000] overflow-hidden flex items-center justify-center shadow-2xl transition-all"
        style={{
      ...
      >
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div
            ref={lettersRef}
            className="absolute left-[180px] flex items-center gap-4 h-full pointer-events-none"
          >
            {/* Orange Vertical Divider */}
            <div
              ref={dividerRef}
              className="w-1.5 h-16 bg-[#FF8000] rounded-full shadow-sm"
              style={{
            ...
            <div className="flex items-center gap-1.5 font-black text-[68px] leading-none tracking-tight text-[#220738]">
              <span

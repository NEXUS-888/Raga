  ...
  return (
    <div className="absolute inset-0 w-full h-full pointer-events-none select-none overflow-hidden">
      ...
      >
        ...
        {/* 1. Day Base Ocean Water Body (Horizon Y: 565 to Y: 745) */}
        <rect x="0" y="565" width="1920" height="185" fill="url(#oceanDeepGrad)" className="ocean-day" />

        {/* 2. Night Base Ocean Water Body (Crossfades in on mic pull) */}
        <rect x="0" y="565" width="1920" height="185" fill="url(#oceanNightGrad)" className="ocean-night" />

        {/* 3. Wave Layer 1 (Distant Horizon Swell) */}
        ...
        {/* 4. Wave Layer 2 (Mid-distance Rolling Waves) */}
        ...
        {/* 5. Golden Sun Specular Reflection Column (Day State) */}
        <g ref={sunReflectionRef} id="sunReflectionMaster" className="ocean-day">
        ...
        {/* 6. Cool Moonlit Specular Shimmer Column (Night State) */}
        <g ref={moonReflectionRef} id="moonReflectionMaster" className="ocean-night">
        ...
        {/* 7. Wave Layer 3 (Foreground Rolling Crests) */}
        ...
        {/* 8. Wave Layer 4 (Shore Surf Wash) */}

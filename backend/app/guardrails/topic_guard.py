...
class TopicGuard:
    ...
    def __init__(self):
        ...
        self.msmarco_domain_keywords = {
            ...
            # Indic Transliterations & Stems (Hindi, Kannada, Telugu, Tamil, Bengali, Marathi, Gujarati, Malayalam)
            'गोवा', 'गोव्या', 'गोव्याची', 'गोव्यातील', 'पणजी', 'कोंकणी', 'मराठी', 'बेबिंका', 'फेनी', 'जाकुती', 'विंदालू', 'अगुआड़ा', 'दूधसागर', 'मंगेशी', 'शांतादुर्गा', 'तांबडी सुरला', 'शिगमो', 'खान-पान', 'किल्ला', 'किल्ले', 'खाद्यपदार्थ',
            'ಗೋವಾ', 'ಗೋವಾದ', 'ಗೋವಾದಲ್ಲಿ', 'ಪಣಜಿ', 'ಕೊಂಕಣಿ', 'ಮರಾಠಿ', 'ಬಾಗಾ', 'ಕಲಂಗೂಟ್', 'ಅಂಜುನಾ', 'ಮಂಗೇಶಿ', 'ಶಾಂತಾದುರ್ಗಾ', 'ದೂಧ್‌ಸಾಗರ್', 'ದ್ಯುತಿಸಂಶ್ಲೇಷಣೆ', 'ವಿಟಮಿನ್',
            'గోవా', 'గోవాలో', 'పనాజీ', 'కొంకణి', 'మంగేషి', 'శాంతాదుర్గా', 'దూధ్‌సాగర్', 'విటమిన్', 'కిరణజన్య సంయోగక్రియ',
            'கோவா', 'கோவாவின்', 'பனாஜி', 'கொங்கணி', 'மங்கேஷி', 'சாந்தாதுர்கா', 'வைட்டமின்', 'ஒளிச்சேர்க்கை',
            'গোয়া', 'গোয়ার', 'পানাজি', 'মঙ্গেশি', 'শান্তাদুর্গা', 'দুধসাগর', 'ভিটামিন', 'ভিটামিন ডি', 'লক্ষণ', 'সালোকসংশ্লেষ',
            'ગોવા', 'ગોવાની', 'ખોરાક', 'દરિયાકિનારો', 'કિલ્લો', 'મંદિર', 'રાજધાની',
            'ഗോവ', 'ഗോവയുടെ', 'ഭക്ഷണം', 'കടൽത്തീരം', 'കോട്ട', 'ക്ഷേത്രം', 'തലസ്ഥാനം', 'വൈറ്റമിൻ'
        }
        ...
        self.generic_domain_intents = {
            ...
            # Hindi
            'समुद्र तट', 'बीच', 'किला', 'किले', 'चर्च', 'मंदिर', 'त्योहार', 'उत्सव', 'झरना', 'व्यंजन', 'भोजन', 'खान-पान', 'संस्कृति', 'इतिहास', 'राजधानी', 'भाषा', 'राजभाषा', 'किल्ले',
            # Kannada
            'ಆಹಾರ', 'ಊಟ', 'ತಿಂಡಿ', 'ಕಡಲತೀರ', 'ಕಡಲತೀರಗಳು', 'ಬೀಚ್', 'ಕೋಟೆ', 'ಕೋಟೆಗಳು', 'ದೇವಸ್ಥಾನ', 'ದೇವಾಲಯ', 'ದೇವಾಲಯಗಳು', 'ರಾಜಧಾನಿ', 'ಹಬ್ಬ', 'ಸಂಸ್ಕೃತಿ', 'ಇತಿಹಾಸ', 'ಜಲಪಾತ', 'ಭಾಷೆ',
            # Telugu
            'ఆహారం', 'భోజనం', 'బీచ్', 'కోట', 'దేవాలయం', 'దేవాలయాలు', 'రాజధాని', 'పండుగ', 'సంస్కృతి', 'చరిత్ర', 'జలపాతం', 'భాష',
            # Tamil
